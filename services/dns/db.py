...
DB_STATS_FULLPATH = ROOT_PATH / DNS_DB.get("stats").get("path")
DB_HISTORY_FULLPATH = ROOT_PATH / DNS_DB.get("history").get("path")
...
class DnsStatsDb:
    ...
    def _is_key_valid(cls, key: str) -> bool:
        ...
        if not cls._running or not cls._cursor or not cls._conn or not cls._valid_columns:
            return False
