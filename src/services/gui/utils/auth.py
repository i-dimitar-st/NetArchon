"""Utility functions for generating and verifying authentication tokens."""
...
def generate_csrf_token() -> str:
    ...
    Returns:
        str: A hexadecimal string representing the CSRF token.
...
def generate_bearer_token(
    csrf_token: str, bearer_token_hash: str = BEARER_TOKEN_HASH
) -> str:
    """Generate a HMAC-based token using a CSRF token secret hash.
