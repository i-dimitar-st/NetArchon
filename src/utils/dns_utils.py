...
Utility functions for working with DNS queries and records.

Provides methods to:
- Normalize domain names
- Check if a query is local to a zone
- Extract hostnames from domains
- Validate domain formats
- Extract TTL values from DNS records
- Generate cache keys for DNS records.
"""
