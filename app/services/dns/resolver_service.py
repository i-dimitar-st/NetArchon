...
from app.services.dns.metrics import dns_metrics, dns_metrics_external
...
class ResolverService:
    ...
    def _handle_blacklist(cls, dns_req_message: DNSReqMessage) -> bool:
        ...
        if BlacklistService.is_blacklisted_cache_if_hit(dns_req_message.domain):
        ...
        try:
            ...
            if dns_res_message:
                cls._dns_cache.add(
                    ...
                    ttl=max(DNSUtils.extract_ttl(dns_res_message), DNS_CACHE_TTL),
